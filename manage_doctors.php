...
?>
      ...
      <div class="main-content">
          <div class="py-5">
              <h2 class="text-center">Registered Packages</h2>
          </div>
          <div class="row">
...
$sql = "SELECT * FROM doctors WHERE status = 'approved' ORDER BY doc_id ASC";
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        echo "<tr>
              ...
              <td>".htmlspecialchars($row["doc_price"])."</td>
              <td>
                <form action='remove_from_doctors.php' method='post'>
