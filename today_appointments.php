...
$sql = "SELECT * FROM appointments WHERE appointment_date = CURDATE() AND doc_id = '$doc_id'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (mysqli_query($conn, $sql)) {
    echo "<script>alert('Appointment updated successfully.');window.location.href = 'today_appointments.php';</script>";
  } else {
